...
{
    /// <summary>
    /// Formats decimal values using an explicit format policy and stable formatter identity.
    /// </summary>
    public sealed class DecimalFormatter : IValueFormatter
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecimalFormatter"/> class.
        /// </summary>
        /// <param name="id">Stable identity for the formatter.</param>
        /// <param name="formatString">Decimal format string for this formatter intent.</param>
        /// <param name="formatProvider">Default format provider. If null, current culture is used.</param>
        public DecimalFormatter(FormatterId id, string formatString, IFormatProvider formatProvider = null)
        {
            if (id == null)
            {
        ...
        /// <param name="formatString">Decimal format string for this formatter intent.</param>
        /// <param name="formatProvider">Default format provider. If null, current culture is used.</param>
        public DecimalFormatter(string id, string formatString, IFormatProvider formatProvider = null)
        ...
        /// <summary>
        /// Gets the decimal format string used by this formatter.
        /// </summary>
        ...
        /// <summary>
        /// Formats an object value as decimal.
        /// </summary>
